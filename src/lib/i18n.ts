...
const messages = {
  "zh-CN": {
    ...
    "firstRun.description": "首次启动需要下载 Node.js 运行时和 DeepSeek Harness。",
    ...
    "firstRun.npmExplanation": "安装缓慢时可切换 npm 下载源。重新开始会停止当前安装，并使用所选来源重新下载 DeepSeek Harness。",
    "firstRun.nodeExplanation": "下载缓慢时可切换 Node.js 来源。重新开始会停止当前下载，并使用所选来源从头下载。",
    ...
    "main.recovered": "DeepSeek Harness 曾意外退出，已自动恢复（第 {attempt} 次）",
    "host.starting": "正在启动 DeepSeek Harness…",
    "settings.back": "返回",
    "settings.backAria": "返回 DeepSeek Harness",
    "settings.title": "设置",
    "settings.plugins": "插件",
    "settings.description": "管理 DeepSeek Harness 的运行时、更新源和诊断信息。",
    "settings.pluginsDescription": "插件市场和已安装插件管理将在后续版本提供。",
    ...
    "command.description": "在新终端中管理与启动器相同的 DeepSeek Harness profile",
    ...
    "uninstall.description": "清除当前托管的 DeepSeek Harness、Node.js 运行时和设置，保留启动器与诊断日志。重新打开后即可重新安装。",
    "uninstall.action": "重新安装",
    "uninstall.confirm": "确认后将关闭应用并清除当前托管环境。重新打开启动器后，即可重新安装 DeepSeek Harness。",
    "common.cancel": "取消",
    ...
    "update.failedDescription": "新版本没有安装成功，当前版本仍然可以继续使用。",
    "update.failed": "更新失败",
    "update.changeSource": "更换源",
    "update.nodeRequired": "需要升级 Node",
    "update.nodeRequiredDescription": "dsh {dshVersion} 需要 Node {requiredVersion}，当前为 {currentVersion}。",
    "update.currentNode": "当前 Node",
    "update.willInstall": "将安装",
    "update.cancel": "取消更新",
    "update.confirm": "确认升级并继续",
    "update.updating": "正在更新 dsh",
    "update.updatingDescription": "正在下载并校验新版本，当前会话继续使用旧版本。",
    "update.current": "当前",
    "update.target": "目标",
    "update.wait": "请稍候",
    ...
    "crash.description": "Host 在短时间内崩溃了 {count} 次（自动重试上限 {limit} 次）{detail}，已停止自动重启。",
    ...
    "settings.nodeUpgradeDescription": "dsh {dshVersion} 需要 Node {requiredVersion}，当前为 {currentVersion}。确认后将下载 Node {targetVersion} 并继续更新。",
    "settings.upgrading": "升级中…",
    "settings.nodeUpdateTitle": "更新 Node.js",
    "settings.nodeUpdateDescription": "将从 {currentVersion} 更新至 {targetVersion}。该操作只更新 Node.js，不安装或切换 dsh，运行中的 dsh 会继续使用当前进程。",
    "settings.compatibility": "兼容要求：",
    "settings.noCompatibility": "当前 dsh 未声明 Node.js 兼容范围，将使用 launcher 已验证的版本。",
    ...
    "update.rollbackVersion": "版本 {version} 无法启动，已恢复 {activeVersion}。",
    "update.noVersion": "未获取到可安装的新版本，请重新检查更新。",
    "update.running": "更新中…",
    "update.now": "立即更新",
    "update.available": "发现新版本",
    "update.availableDescription": "当前 {currentVersion}，可更新至 {targetVersion}。更新会在你确认后开始，并自动重启服务。",
  ...
  "en-US": {
    ...
    "firstRun.description": "The first launch downloads the Node.js runtime and DeepSeek Harness.",
    ...
    "firstRun.npmExplanation": "If installation is slow, choose another npm registry. Restarting stops the current installation and downloads DeepSeek Harness again from the selected registry.",
    "firstRun.nodeExplanation": "If download is slow, choose another Node.js source. Restarting stops the current download and starts again from the selected source.",
    ...
    "main.recovered": "DeepSeek Harness exited unexpectedly and was recovered automatically (attempt {attempt})",
    "host.starting": "Starting DeepSeek Harness…",
    "settings.back": "Back",
    "settings.backAria": "Back to DeepSeek Harness",
    "settings.title": "Settings",
    "settings.plugins": "Plugins",
    "settings.description": "Manage the DeepSeek Harness runtime, update sources, and diagnostics.",
    "settings.pluginsDescription": "Plugin marketplace and installed-plugin management will be available in a later release.",
    ...
    "environment.nodeHint": "Only Node.js will be updated; the running dsh will not restart",
    ...
    "command.description": "Manage the same DeepSeek Harness profile as the launcher from a new terminal",
    ...
    "sources.npmDescription": "Used for the next DeepSeek Harness installation or update",
    ...
    "support.exportDescription": "Bundle application state and logs to help investigate an issue",
    "support.exporting": "Exporting…",
    "support.export": "Export",
    "uninstall.title": "Reinstall",
    "uninstall.runtime": "Reinstall DeepSeek Harness",
    "uninstall.description": "Clear the managed DeepSeek Harness, Node.js runtime, and settings while keeping the launcher and diagnostic logs. Reopen the launcher to install it again.",
    "uninstall.action": "Reinstall",
    "uninstall.confirm": "The app will close and clear the current managed environment. Reopen the launcher to install DeepSeek Harness again.",
    ...
    "update.failedDescription": "The new version could not be installed. The current version is still available.",
    "update.failed": "Update failed",
    "update.changeSource": "Change source",
    "update.nodeRequired": "Node upgrade required",
    "update.nodeRequiredDescription": "dsh {dshVersion} requires Node {requiredVersion}; you are using {currentVersion}.",
    ...
    "update.updatingDescription": "Downloading and verifying the update. Your current session keeps using the old version.",
    ...
    "crash.description": "The host crashed {count} times in a short period (automatic retry limit: {limit}){detail}. Automatic restarts have stopped.",
    "crash.hint": "Try starting again, or roll back to the previous stable version if the new version is the problem.",
    ...
    "settings.nodeDownloading": "Downloading and verifying the Node.js runtime…",
    ...
    "settings.nodeSourceSaveFailed": "Unable to save the Node.js download source. Try again.",
    "settings.npmSourceSaveFailed": "Unable to save the npm registry. Try again.",
    "settings.loading": "Loading settings",
    "settings.loadFailed": "Unable to load settings",
    "settings.nodeUpgradeDescription": "dsh {dshVersion} requires Node {requiredVersion}; you are using {currentVersion}. Node {targetVersion} will be downloaded before the update continues.",
    "settings.upgrading": "Upgrading…",
    "settings.nodeUpdateTitle": "Update Node.js",
    "settings.nodeUpdateDescription": "Node.js will be updated from {currentVersion} to {targetVersion}. This does not install or switch dsh, and the running dsh keeps using the current process.",
    "settings.compatibility": "Compatibility:",
    "settings.noCompatibility": "The current dsh does not declare a Node.js compatibility range. A launcher-verified version will be used.",
    "settings.cancelDownload": "Cancel download",
    "settings.updating": "Updating…",
    "firstRun.nodeVerified": "SHA-256 verified",
    "firstRun.nodeResolving": "Checking the DeepSeek Harness version and Node.js requirement…",
    ...
    "firstRun.dshDownloading": "npm install is running; {count} packages processed…",
    ...
    "update.rollbackVersion": "Version {version} could not start; restored {activeVersion}.",
    "update.noVersion": "No installable new version was found. Check for updates again.",
    "update.running": "Updating…",
    "update.now": "Update now",
    "update.available": "Update available",
    "update.availableDescription": "Current {currentVersion}; update available: {targetVersion}. The update starts after you confirm and automatically restarts the service.",
